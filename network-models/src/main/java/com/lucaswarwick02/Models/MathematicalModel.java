...
public class MathematicalModel {
    ...
    public void runSimulation(int iterations, int initialInfected) {
        ...
        // modelStates[0] = new ModelState(0, populationSize - initialInfected,
        // initialInfected, 0, 0);

        // for (int t = 1; t < iterations; t++) {
        // float changeInS = -1f * (this.rateOfInfection * modelStates[t - 1].infected()
        // * modelStates[t - 1].susceptible())
        // - (this.rateOfVaccination * modelStates[t - 1].susceptible());
        // float changeInI = (this.rateOfInfection * modelStates[t - 1].infected() *
        // modelStates[t - 1].susceptible())
        // - (this.rateOfRecovery * modelStates[t - 1].infected());
        // float changeInR = (this.rateOfRecovery * modelStates[t - 1].infected());
        // float changeInV = (this.rateOfVaccination * modelStates[t -
        // 1].susceptible());
